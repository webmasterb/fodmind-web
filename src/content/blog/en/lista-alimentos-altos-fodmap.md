...
When you start the low FODMAP diet, the first thing you look for is a list of what you "can" and "cannot" eat. The list exists, but it has a catch: **no food is high in FODMAPs in the abstract; it is high in a specific serving**. A quarter cup of lentils may be tolerable while a full plate is not. That is why fixed lists fail, and why the Fodmind app classifies by the serving people actually eat.

## The big FODMAP concentrators

**Wheat cereals.** Wheat bread, regular pasta and most baked goods carry fructans. It is not the gluten: it is the type of carbohydrate. Wheat-free breads and pastas do exist.
...
1. Look at the safe serving, not only the color.
